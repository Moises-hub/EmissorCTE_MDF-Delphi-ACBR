object CDM: TCDM
  ...
  object CD_Emissor_CTE: TClientDataSet
    ...
    object CD_Emissor_CTECFOP: TStringField
      FieldKind = fkLookup
      FieldName = 'CFOP'
      LookupDataSet = CD_N_Operacao
      LookupKeyFields = 'ID_NATUREZA'
      LookupResultField = 'CODIGO_FISCAL'
      KeyFields = 'ID_NATUREZA'
      Size = 10
      Lookup = True
    end
    ...
    object CD_Emissor_CTEFRETE: TFloatField
      FieldName = 'FRETE'
      currency = True
    end
    object CD_Emissor_CTEDESPACHO: TFloatField
      FieldName = 'DESPACHO'
      currency = True
    end
    object CD_Emissor_CTEST: TStringField
      FieldKind = fkLookup
      FieldName = 'ST'
      LookupDataSet = CD_N_Operacao
      LookupKeyFields = 'ID_NATUREZA'
      LookupResultField = 'TRIBUTACAO'
      KeyFields = 'ID_NATUREZA'
      Size = 10
      Lookup = True
    end
    object CD_Emissor_CTETIPOEMI: TIntegerField
      FieldName = 'TIPOEMI'
    end
    object CD_Emissor_CTECODIGO: TStringField
      FieldName = 'CODIGO'
      Size = 10
    end
  end
  ...
  object CD_N_Operacao: TClientDataSet
    ...
    object CD_N_OperacaoREDUCAO_ICMS_SUB: TSingleField
      FieldName = 'REDUCAO_ICMS_SUB'
    end
    object CD_N_OperacaoSUBSTITUICAO: TSingleField
      FieldName = 'SUBSTITUICAO'
    end
    object CD_N_OperacaoID_EMPRESA: TIntegerField
      FieldName = 'ID_EMPRESA'
    end
    object CD_N_OperacaoMOB_ACESSO: TSmallintField
      FieldName = 'MOB_ACESSO'
    end
    object CD_N_OperacaoMOB_ORDEM: TSmallintField
      FieldName = 'MOB_ORDEM'
    end
  end
  ...
  object CD_CTE_UN: TClientDataSet
    ...
    Params = <>
    ProviderName = 'Prov_CTE_UN'
    BeforeInsert = CD_CTE_UNBeforeInsert
    AfterInsert = CD_CTE_UNAfterInsert
    ...
    object CD_CTE_UNID: TIntegerField
      FieldName = 'ID'
      Required = True
    end
  end
  ...
  object CD_Carta: TClientDataSet
    ...
    object CD_CartaCHAVE_CC: TStringField
      FieldName = 'CHAVE_CC'
      Size = 80
    end
  end
  ...
  object Query_Unidade: TFDQuery
    Connection = FDConnection1
    SQL.Strings = (
      
        'select UN,sum(qnt) AS QNT from CTE_UNI where cte_uni.id_cte =:c ' +
        ' group BY UN')
    Left = 136
    Top = 536
    ParamData = <
    ...
    object Query_UnidadeUN: TStringField
      FieldName = 'UN'
      Origin = 'UN'
      Size = 10
    end
    object Query_UnidadeQNT: TBCDField
  ...
  object DS_Query_Unidade: TDataSource
    DataSet = Query_Unidade
    Left = 128
    Top = 600
  end
  object Query_Grade_Carta: TFDQuery
    Connection = FDConnection1
    SQL.Strings = (
      'select FIRST 100 * from CTE_CCORRECAO'
      'WHERE CHAVE LIKE :F'
      'ORDER BY ID DESC')
    Left = 248
    Top = 536
    ...
    object Query_Grade_CartaID: TIntegerField
      FieldName = 'ID'
      Origin = 'ID'
      ProviderFlags = [pfInUpdate, pfInWhere, pfInKey]
      Required = True
    end
    object Query_Grade_CartaCHAVE: TStringField
      FieldName = 'CHAVE'
      Origin = 'CHAVE'
      Size = 80
    end
    object Query_Grade_CartaEVENTO: TDateField
      FieldName = 'EVENTO'
      Origin = 'EVENTO'
    end
    object Query_Grade_CartaCPF_CNPJ: TStringField
      FieldName = 'CPF_CNPJ'
      Origin = 'CPF_CNPJ'
    end
    object Query_Grade_CartaSEQUENCIA: TIntegerField
      FieldName = 'SEQUENCIA'
      Origin = 'SEQUENCIA'
    end
    object Query_Grade_CartaCHAVE_CC: TStringField
      FieldName = 'CHAVE_CC'
      Size = 80
    end
  end
  object DS_Query_Grade_Carta: TDataSource
    DataSet = Query_Grade_Carta
    Left = 248
    Top = 600
  end
end
